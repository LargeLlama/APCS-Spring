...
{ 
  ...
  private class MyIterator implements Iterator<T> {
	...
	public MyIterator(){
		_curr = new DLLNode("curr", null, _head);		
		_nextCalled = false;
	}	
	...
	public void remove() {
		if (! _nextCalled) {
			throw new IllegalStateException("CALL next() you dingus");
		}
		if (_curr.getPrev() == null) {
			_curr.getNext().setPrev(null);
		}
		else if (_curr.getNext() == null) {
			_curr.getPrev().setNext(null);
		}
		else {
